...
v_msg_Person(#'Person'{name = F1, id = F2, email = F3},
    ...
    v_type_string(F3, [email | Path], TrUserData),
    ok;
...
get_all_source_basenames() -> ["teste.proto"].
...
%% functions.
get_all_proto_names() -> ["teste"].


get_msg_containment("teste") -> ['Person'];
get_msg_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_pkg_containment("teste") -> undefined;
get_pkg_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_service_containment("teste") -> [];
get_service_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_rpc_containment("teste") -> [];
get_rpc_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_enum_containment("teste") -> [];
get_enum_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_proto_by_msg_name_as_fqbin(<<"Person">>) -> "teste";
